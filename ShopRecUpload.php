...
<head>
    <title>Nahrát prodejny</title>
    <meta charset="UTF-8">
    <meta name="author" content="Jan Sonbol" />
    <meta name="description" content="Nahrát prodejny" />
...
if(isset($_POST['submit']))
    ...
    if ($row > 2)
        ...
        foreach($Records as $ShopRec)
            ...
            $Connection->insert("Shop", $data);
            }
        }
    }

echo "<h2>Vyberte soubor s prodejnami k načtení:</h2>";
echo "<form action='ShopRecUpload.php' method='post' enctype='multipart/form-data'>";
